        ...
        <div className="px-5 pb-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="avatar">
              <div className="w-8 md:w-14 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                <img src={author_img} />
              </div>
            </div>
            <div>
          ...
          <div>
            <div className="text-gray-900 dark:text-white text-sm md:text-base flex items-center gap-2">
